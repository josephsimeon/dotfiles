...
exe 'hi CursorLine	guifg='s:background
exe 'hi CursorLine      guibg='s:foreground
exe 'hi CursorLine      gui='s:selection_term
exe 'hi CursorLine	ctermfg='s:background_256
exe 'hi CursorLine      ctermbg='s:foreground_256
exe 'hi CursorLine      cterm='s:selection_term
